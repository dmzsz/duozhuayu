...
import (
	...
	V1PostgresRepository "github.com/dmzsz/duozhuayu/internal/datasources/repositories/postgres/v1"
	V1Handler "github.com/dmzsz/duozhuayu/internal/http/handlers/v1"
	V1EmailService "github.com/dmzsz/duozhuayu/internal/services/emailservice/v1"
	V1Usecase "github.com/dmzsz/duozhuayu/internal/services/userservice/v1"
...
func NewUsersRoute(router *gin.RouterGroup, db *sqlx.DB, redisCache *caches.RedisCache, ristrettoCache caches.RistrettoCache, authMiddleware gin.HandlerFunc, mailer V1EmailService.EmailService) *usersRoutes {
