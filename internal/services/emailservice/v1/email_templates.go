...
const (
	...
	newSubject     = "Instructions for verify your new account."
)
...
const verifyHTMLTmpl = `
	Hello there!<br/>
	<br/>
	It appears that you have requested a verfiy Email.
	If this was you, please make VERIFY API Request to update your account:<br/>
	<br/>
	URL: %s <br/>
	<br/>
	If you are asked for a token, please use the following value:<br/>
	...
	%s<br/>
	<br/>
	If you didn't request a verfiy Email you can safely ignore this email and your account will not be changed.<br/>
	<br/>
	Best,<br/>
	Support<br/>
`

const verifyTextTmpl = `
	Hi there!

	It appears that you have requested a verfiy Email. If this was you, please follow the link below to update your account:
	...
	If you didn't request a verfiy Email you can safely ignore this email and your account will not be changed.
